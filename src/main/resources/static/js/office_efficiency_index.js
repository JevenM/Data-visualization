...
function loadChannelBaseInfo (data) {
	...
	if (finalDeviceScore <= 0) {
		$("#base-info .device-score").find("img").attr("src", "/img/star3.png")
	} else if (finalDeviceScore < 0.95) {
		$("#base-info .device-score").find("img").attr("src", "/img/star2.png")
	} else {
		$("#base-info .device-score").find("img").attr("src", "/img/star1.png")
	}
	...
	if (channelStartWeiGui == 1) {
		$("#base-info .weigui").find("img").attr("src", "/img/star1.png")
	} else {
		$("#base-info .weigui").find("img").attr("src", "/img/star3.png")
	}
	...
	if (yingxiaoval <= 0) {
		$("#base-info .yingxiao").find("img").attr("src", "/img/star3.png")
	} else if (yingxiaoval < 0.95) {
		$("#base-info .yingxiao").find("img").attr("src", "/img/star2.png")
	} else {
		$("#base-info .yingxiao").find("img").attr("src", "/img/star1.png")
	}
	...
	if (avgTimeScore <= 0) {
		$("#base-info .avgtime").find("img").attr("src", "/img/star3.png")
	} else if (avgTimeScore < 0.95) {
		$("#base-info .avgtime").find("img").attr("src", "/img/star2.png")
	} else {
		$("#base-info .avgtime").find("img").attr("src", "/img/star1.png")
	}
	...
	if (yewuliangVal <= 0) {
		$("#base-info .yewuliang").find("img").attr("src", "/img/star3.png")
	} else if (yewuliangVal < 0.95) {
		$("#base-info .yewuliang").find("img").attr("src", "/img/star2.png")
	} else {
		$("#base-info .yewuliang").find("img").attr("src", "/img/star1.png")
	}
	...
	if (starLen < channelTotalScore) {
		var img = '<img src="/img/star2.png" style="width:21px;height:20px;"/>'
		$("#base-info").find("#chanenl-star").append(img)
	}
	var unit = ""
	if (channelSum > 90000) {
...
function noDataTip ($selector) {
	...
	var $li = [
		...
		"<img src='/img/no-data.png' style='width:200px;height:200px;'/>",
